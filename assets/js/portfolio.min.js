(function ($) {
    ...
    function initTypedJs() { const selectTyped = document.querySelector('.typed'); if (typeof Typed !== 'undefined' && selectTyped) { let typed_strings = i18nUtil.getTranslation('hero_typed_items'); if (typed_strings) { new Typed('.typed', { strings: typed_strings, loop: !0, typeSpeed: 80, backSpeed: 50, backDelay: 2000 }) } } }
