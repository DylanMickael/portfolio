(function ($) {
    ...
    function initTypedJs() {const selectTyped = document.querySelector('.typed'); if (typeof Typed !== 'undefined' && selectTyped) {const frenchStrings = ["Développeur web", "Designer", "Orateur"];const englishStrings = ["Web Developer", "Designer", "Public speaker"]; let typed_strings = localStorage.getItem("PREFERED_LANGUAGE") && localStorage.getItem("PREFERED_LANGUAGE") === "FR" ? frenchStrings : englishStrings; if (typed_strings) { new Typed('.typed', { strings: typed_strings, loop: !0, typeSpeed: 80, backSpeed: 50, backDelay: 2000 }) } } }
