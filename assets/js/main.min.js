(function ($) {
    ...
    function animateText(startAnimation) {
        ...
        const options = { strings: localStorage.getItem("PREFERED_LANGUAGE") && localStorage.getItem("PREFERED_LANGUAGE") === "FR" ? frenchStrings : englishStrings, typeSpeed: 20, backSpeed: 15, loop: !1, showCursor: !0, backDelay: 2000, cursorChar: "|", autoInsertCss: !0, onComplete: function (self) { startAnimation() } }; const typed = new Typed("#typed-text", options)
    }
