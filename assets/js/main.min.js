(function ($) {
    ...
    function animateText(startAnimation) {
        const frenchStrings = ["", "Tout peut sembler petit au début.", "Mais ton talent grandira...", "COMME UNE SINGULARITÉ."]
        const englishStrings = ["", "What you do may seem small now.", "But your talent will expand...", "LIKE A SINGULARITY."]
        const options = { strings: localStorage.getItem("PREFERED_LANGUAGE") && localStorage.getItem("PREFERED_LANGUAGE") === "FR" ? frenchStrings : englishStrings, typeSpeed: 15, backSpeed: 15, loop: !1, showCursor: !0, backDelay: 2000, cursorChar: "|", autoInsertCss: !0, onComplete: function (self) { startAnimation() } }; const typed = new Typed("#typed-text", options)
    }
