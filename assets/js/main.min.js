(function ($) {
    ...
    function animateText(startAnimation) {
        const options = { strings: i18nUtil.getTranslation('story_tell'), typeSpeed: 15, backSpeed: 15, loop: !1, showCursor: !0, backDelay: 2000, cursorChar: "|", autoInsertCss: !0, onComplete: function (self) { startAnimation() } }; const typed = new Typed("#typed-text", options)
    }
