(function(){
    ...
    const selectedFlag = window.location.pathname.includes('en') ? flags.unitedKingdom : flags.french;
    const unSelectedFlag = window.location.pathname.includes('en') ? flags.french : flags.unitedKingdom;
    ...
    const $languageDropdown = `
        <div class="dropdown">
            ...
            <ul class="dropdown-menu" aria-labelledby="languageDropdown">
                ...
                <li>
                    <a class="dropdown-item" href="${unSelectedFlag.link}">
