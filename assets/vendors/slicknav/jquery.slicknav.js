;(function ($, document, window) {
    ...
    Plugin.prototype.init = function () {
        ...
        // Ajout du language selector juste après le bouton
        $(menuBar).append($this.btn);
        if (settings.languageSelectorHtml && settings.languageSelectorHtml !== '') {
            $(menuBar).append(settings.languageSelectorHtml);
        }
